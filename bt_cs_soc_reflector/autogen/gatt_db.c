...
GATT_DATA(const sli_bt_gattdb_attribute_t gattdb_attributes_map[]) = {
  ...
  { .handle = 0x1d, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x02, .char_uuid = 0x000a } },
  { .handle = 0x1e, .uuid = 0x000a, .permissions = 0x811, .caps = 0xffff, .state = 0x00, .datatype = 0x07, .dynamicdata = NULL },
  { .handle = 0x1f, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x30, .char_uuid = 0x000b } },
  { .handle = 0x20, .uuid = 0x000b, .permissions = 0x1800, .caps = 0xffff, .state = 0x00, .datatype = 0x07, .dynamicdata = NULL },
  { .handle = 0x21, .uuid = 0x000c, .permissions = 0x913, .caps = 0xffff, .state = 0x00, .datatype = 0x07, .dynamicdata = NULL },
  { .handle = 0x22, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x30, .char_uuid = 0x000d } },
  { .handle = 0x23, .uuid = 0x000d, .permissions = 0x1800, .caps = 0xffff, .state = 0x00, .datatype = 0x07, .dynamicdata = NULL },
  { .handle = 0x24, .uuid = 0x000c, .permissions = 0x913, .caps = 0xffff, .state = 0x00, .datatype = 0x07, .dynamicdata = NULL },
  { .handle = 0x25, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x24, .char_uuid = 0x000e } },
  { .handle = 0x26, .uuid = 0x000e, .permissions = 0x1904, .caps = 0xffff, .state = 0x00, .datatype = 0x07, .dynamicdata = NULL },
  { .handle = 0x27, .uuid = 0x000c, .permissions = 0x913, .caps = 0xffff, .state = 0x00, .datatype = 0x07, .dynamicdata = NULL },
  { .handle = 0x28, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x32, .char_uuid = 0x000f } },
  { .handle = 0x29, .uuid = 0x000f, .permissions = 0x1811, .caps = 0xffff, .state = 0x00, .datatype = 0x07, .dynamicdata = NULL },
  { .handle = 0x2a, .uuid = 0x000c, .permissions = 0x913, .caps = 0xffff, .state = 0x00, .datatype = 0x07, .dynamicdata = NULL },
  { .handle = 0x2b, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x32, .char_uuid = 0x0010 } },
  { .handle = 0x2c, .uuid = 0x0010, .permissions = 0x1811, .caps = 0xffff, .state = 0x00, .datatype = 0x07, .dynamicdata = NULL },
  { .handle = 0x2d, .uuid = 0x000c, .permissions = 0x913, .caps = 0xffff, .state = 0x00, .datatype = 0x07, .dynamicdata = NULL },
};

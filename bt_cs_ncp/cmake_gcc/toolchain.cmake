...
elseif(WIN32)
  set(TOOLCHAIN_DIR "C:/Users/YmeBrugts/.silabs/slt/installs/conan/p/gcc-ab83b3403fdca6/p//bin/")
elseif(APPLE)
...
elseif(WIN32)
  set(POST_BUILD_EXE "C:/Users/YmeBrugts/.silabs/slt/installs/archive/Simplicity Commander/commander.exe")
elseif(APPLE)
  set(POST_BUILD_EXE "")
else()
  set(POST_BUILD_EXE "")
...
elseif(WIN32)
  set(NINJA_RUNTIME_PATH "C:/Users/YmeBrugts/.silabs/slt/installs/conan/p/ninja1a38fc85adcf7/p/ninja.exe")
elseif(APPLE)
